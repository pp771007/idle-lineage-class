...
(function () {
  ...
  var SPECIAL_BLOCKS = [
    { id: 'dropmult', title: '🔮 掉落倍率：席琳的世界 ×3、瘋狂的席琳世界 ×5、恩賜怪 ×10、經典 ×1/10', keys: ['掉落倍率', '倍率', '席琳的世界', '瘋狂的席琳世界', '經典模式', '恩賜怪', '恩賜'], lines: [
      ...
      '<b>固定、不受倍率影響的例外</b>：怪物卡片（普／銀／金卡）、萬能藥（屬性藥）、黑魔石、銀礦石、進化果實（各條另有標註）；其餘怪卡掉落都會被倍率放大／縮小',
      '<b>席琳結晶</b>比較特別：不吃「席琳的世界 ×3」與「恩賜怪 ×10」（機率直接由怪物等級決定），但吃「瘋狂 ×3」與「經典 ×1/10」——詳見下方席琳結晶那條',
    ...
    { id: 'sherine', title: '🔮 席琳結晶（席琳的世界限定）', keys: ['席琳結晶'], lines: [
      ...
      '倍率：<b>不受</b>「席琳的世界 ×3」與「恩賜怪 ×10」影響；<b>瘋狂的席琳世界 ×3</b>；<b>經典模式 ×1/10</b>',
    ...
    { id: 'remains', title: '🦴 席琳遺骸（套裝效果的唯一來源）', keys: ['席琳遺骸', '遺骸', '之爪', '之眼', '之血', '之肉', '之心', '之骨', '之牙', '之鱗', '伊奧', '菈克希絲'], lines: [
      ...
      '② <b>席琳神殿・菈克希絲</b>：把<b>身上穿著</b>、帶有舊席琳詞綴的裝備拆分成對應部位的遺骸（免費、裝備與強化值都保留，只有詞綴被取下）',
