...
(function () {
  window.AFK_EXTRA = {
    ...
    itemAcquire: {
      ...
      rem_claw:  { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的武器拆分而來。' },
      rem_eye:   { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的頭盔拆分而來。' },
      rem_blood: { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的斗篷拆分而來。' },
      rem_flesh: { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的長靴／脛甲拆分而來。' },
      rem_heart: { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的腰帶拆分而來。' },
      rem_bone:  { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的手套拆分而來。' },
      rem_fang:  { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的副手（盾牌／臂甲）拆分而來。' },
      rem_scale: { short: '席琳神殿「伊奧」用席琳結晶 ×1 兌換（詞綴隨機一種）；或「菈克希絲」把身上帶舊席琳詞綴的盔甲拆分而來。' },
      doll_bag: {
