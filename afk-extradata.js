...
(function () {
  window.AFK_EXTRA = {
    ...
    skillNote: {
      ...
      // ── 幻術士（記憶水晶）──
      sk_illu_crush: '用武器打一擊，但傷害改吃魔法加成：基礎＝武器骰（依目標體型決定大／小骰）＋近距離或遠距離傷害（依你的武器）＋武器強化值，整體再乘魔法傷害加成（1＋魔法傷害÷16）；不計武器特效，最後扣目標的傷害減免與硬皮',
      ...
      sk_dragon_bloodlust: '攻擊速度 ＋33%，可與自我加速、變身、覺醒相乘疊加（不互相覆蓋）',
