...
(function () {
  ...
  function open() {
    ...
    body.innerHTML =
      ...
      '它會<b>改寫你每一格存檔</b>,而且<b>沒有復原鈕</b>。本功能要配合遊戲內部的存檔格式運作,' +
      '<b>遊戲改版後格式若有變動,有可能導致存檔損毀</b>——動手前請務必先把<b>所有角色</b>匯出成檔案。<br>' +
      '只有在你曾經用匯出/匯入複製過角色、' +
      ...
      '<div class="m-rid-h">動手前請先匯出所有角色</div>' +
      '<div class="m-rid-warn">這個動作<b>沒有復原鈕</b>,而且會<b>改寫每一格存檔</b>。' +
      '遊戲改版後存檔格式若有變動,<b>有可能導致存檔損毀</b>——一旦發生,只有你自己的備份檔救得回來。<br>' +
      '請先回主選單用原本的<b>「匯出存檔」</b>,把<b>每一個角色</b>都存成檔案再繼續。' +
    ...
    foot.innerHTML =
      ...
      '<span>我已經把<b>所有角色都匯出成檔案備份</b>了,也知道萬一存檔損毀只能靠這些備份還原。</span></label>' +
