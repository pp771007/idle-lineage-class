...
(function () {
  ...
  var QUEST_BY_CLASS = {
    ...
    royal: {
      ...
      trials: [
        ...
        { n: '四本特殊王族魔法書（灼熱武器／勇猛意志／閃亮之盾／王者加護）', npc: '拉比安尼 ＠說話之島', req: '龍之心、高崙之心、冰之女王之心、鳳凰之心 各 ×1', from: '四顆心臟分別打對應 BOSS 取得（龍／高崙／冰之女王／不死鳥）', rw: '四選一，製作一本特殊王族魔法書' }
      ]
    }
  };
  var QUEST_COMMON = [
  ...
  var SKILL_SOURCE_NOTE = {
    ...
    royal: '👑 <b>王族魔法書怎麼拿</b>：「精準目標」「呼喚盟友」在<b>說話之島的甘特</b>試煉兌換；「灼熱武器／勇猛意志／閃亮之盾／王者加護」在<b>說話之島的拉比安尼</b>用 龍之心＋高崙之心＋冰之女王之心＋鳳凰之心 製作。',
