  ...
  function renderPledge() {
    ...
    out += wCard('⚔️ 攻城戰',
      wTbl(['項目', '內容'], [
        ...
        ['占領好處', '全商店 <b>8 折</b>、開放該城「城堡」區域、回村鈕變成回城、可雇城堡護衛／神官；打下風木城另開「風木地監」'],
        ['獲勝後', '直接傳送進你剛拿下的城堡']
      ]) +
    ...
    out += wCard('🏰 城堡護衛 / 神官（持有城池期間可雇一名）',
      wDesc('到你打下那座城的城堡找「傭兵隊長／神官隊長」雇一名；<b>同時只能一名</b>、不攻擊。設 HP 門檻（預設 50%），你 HP 低於門檻才發動。<b>占領期間每天清晨 5 點自動續雇，扣一次雇用價</b>（下表金額）；金幣不足時護衛離開，城池不受影響。失去城堡或改占別座城時護衛也會解散。') +
      wTbl(['城池', '護衛類型'], [
