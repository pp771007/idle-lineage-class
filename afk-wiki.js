...
(function () {
  ...
  function renderPvp() {
    ...
    out += wCard('📣 對整個頻道嗆聲（會被圍毆）',
      wDesc('在世界頻道<b>發問時</b>，如果打的是「對全頻道挑釁」的話，就不會有人回答問題，而是<b>一次得罪一整批人</b>。看得懂的句型例如：<b>在座各位都是垃圾</b>、<b>有種來 PK</b>、<b>不服來單挑</b>、<b>一群廢物</b>、<b>見一個殺一個</b>、<b>你們都是垃圾</b>、<b>全部一起上</b>、<b>我要打十個</b>。（中間插字、標點、空白都不影響判定。）') +
      wTbl(['項目', '內容'], [
  ...
  function renderOffline() {
    ...
    out += wCard('🎁 離線會拿到什麼',
      ...
      wDesc('掉落照樣吃四種倍率：<b>席琳的世界 ×3</b>、<b>瘋狂的席琳世界 ×5</b>、<b>恩賜 ×10</b>、<b>經典模式 ×1/10</b>；黑水晶、銀礦、區域加成道具那些「跟著地圖或技能走」的額外掉落也一起結算。') +
