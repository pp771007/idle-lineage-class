...
(function () {
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '⚔ 經典模式（硬核挑戰）', lines: [
      ...
      '<b>經驗、金幣、掉落機率都和一般模式相同</b>——舊版的「掉落剩 1/10、經驗減半、金幣減半」三項懲罰現在已經取消。',
  ...
  function renderMode() {
    ...
    ) + '<div class="m-wiki-desc" style="margin-top:6px;">・舊版經典模式的「掉落 1/10、經驗減半、金幣減半」<b>三項懲罰都已取消</b>，現在打怪的收益跟一般模式完全一樣；經典的代價只剩<b>死亡扣經驗</b>與下面幾張表列的<b>功能／戰鬥限制</b>。</div>');
