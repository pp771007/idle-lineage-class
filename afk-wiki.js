...
(function () {
  ...
  var EFFECT_OVERRIDE = {
    ...
    sk_summon: '召喚一隻生物為你作戰，等級越高召喚到的生物越強。<b>始終只有 1 隻</b>——魅力提升的是「這隻每輪攻擊幾段」、不是召喚更多隻：每輪攻擊段數＝魅力÷6（無條件捨去，即每 6 點魅力多打一段，魅力 60 時最多 10 段），命中與傷害也隨魅力提升，有「召喚精通」時命中傷害判定改用魅力×1.2。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
    sk_zombie: '造出一隻人形殭屍隨從替你作戰。<b>始終只有 1 隻</b>——魅力提升的是「這隻每輪攻擊幾段」、不是召喚更多隻：每輪攻擊段數＝魅力÷6（無條件捨去，即每 6 點魅力多打一段，魅力 60 時最多 10 段），命中與傷害也隨魅力提升，有「召喚精通」時命中傷害判定改用魅力×1.2。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
  ...
  // 魔法真正分類:有 reqM＝法師魔法(本職法術,1~10階);否則依 reqE/reqD/reqK 歸為各職業專屬
  ...
  var SETS = [
    ...
    { n: '死亡騎士套裝', pcs: 4, items: '死亡騎士手套、盔甲、長靴、頭盔', eff: '防禦 +4，並可變身「真‧死亡騎士」（額外傷害 +6、額外命中 +6、攻擊速度 +35%）；穿滿生效、卸下消失' },
    { n: '克特套裝', pcs: 4, items: '克特盔甲、手套、長靴、頭盔', eff: '防禦 +4，並可變身「真‧克特」（額外傷害 +4、額外命中 +8、攻擊速度 +35%）；穿滿生效、卸下消失' },
    ...
    { n: '惡魔套裝', pcs: 4, items: '惡魔頭盔、惡魔盔甲、惡魔手套、惡魔長靴', eff: '防禦 +2、HP自然恢復 +5，並可變身「惡魔」（變身提供：額外傷害+4、額外命中+4、魔法傷害+3、額外MP+3、MP自然恢復+3、攻速+33%，可與加速／勇敢／餅乾疊加）' }
  ];
  ...
  var ENHANCE_SECTIONS = [
    { t: '強化（把裝備 +1 升級）', lines: [
      ...
      '<b>+1~+10 的加成</b>：武器→每階 額外傷害 +1、額外命中 +1（弓加到遠距）；防具／飾品→防禦每 +1 變好（部分另加魔防）。（+11 以上規則不同，見下一張卡）',
    ...
    { t: '強化上限（+11 以上）', lines: [
      ...
      '<b>防具 +11~+15</b>：在 +10 的防禦之上，每再強化 +1 多 +2 防禦（+11 額外+2、+12 額外+4…到 +15 額外+10，合計 +20 防禦）。飾品上限 +5，沒有 +6 以上，維持每階線性。',
