...
(function () {
  ...
  var WEAPON_TRAITS = [
    ...
    { n: '魔爆（神官魔杖）', d: '施放傷害魔法時依智力觸發引發爆炸（單體魔法：智力 ÷ 100 的機率；全體魔法：智力 ÷ 60 的機率），將「本次魔法傷害的三成」<b>均分</b>給場上所有敵人。代表武器：神官魔杖。' },
  ...
  function renderAlly() {
    ...
    var panelRows =
      ...
      '<tr>' + td('治癒魔法 ＋ HP&lt;門檻%') + td('隊伍（你＋傭兵們）有人 HP 低於門檻（預設 <b>70%</b>）→ 他改放治癒，補最缺血的那個。只要該角色<b>學過治癒術</b>（初／中／高／全部）就能指定。<b>新招募預設不放治癒、以攻擊為主</b>，要補血得在這格<b>手動指定</b>。') + '</tr>' +
