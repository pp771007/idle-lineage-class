...
(function () {
  ...
  var TRIAL_50 = {
    ...
    elf: { n: '妖精 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '兩階段依序交付：①古代黑妖之秘笈 ×1 → ②密封的情報書 ×1', from: '古代黑妖之秘笈：巨大兵蟻 1%（沙漠／螞蟻洞窟 1~2 樓）；密封的情報書：在「大洞穴隱遁者村莊地區」打「魔族暗殺團」必掉（魔族暗殺團為條件出現，見下方）', rw: '完成後開放「魔族神殿」。之後可重複用「炎魔之爪」×1 兌換傳說「赤焰之弓」或「赤焰之劍」' },
    mage: { n: '法師 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '一階段：交付 間諜報告書 ×1', from: '間諜報告書：在「大洞穴隱遁者村莊地區」打「魔族暗殺團」必掉（魔族暗殺團為條件出現，見下方）', rw: '完成後開放「魔族神殿」。之後可重複用「炎魔之心」×1 兌換傳說盾「瑪那水晶球」' },
  ...
  // 50 級試煉後的共通終盤進程(不分職業,顯示一次)
  var TRIAL50_ENDGAME = [
    { t: '魔族暗殺團（特殊怪，符合條件才會出現）', lines: [
      '「魔族暗殺團」<b>不是常駐在場上的怪</b>，只有當你<b>正在跑妖精或法師的 50 級試煉、而且正好缺那一步要交的道具</b>時，牠才會在「大洞穴隱遁者村莊地區」冒出來。',
      '對象：<b>妖精</b>（第 ② 階段、還沒拿到「密封的情報書」）或<b>法師</b>（還沒拿到「間諜報告書」）。符合時，在這張圖每次刷怪有 <b>1%</b> 機率讓牠出現，場上同時只會有一隻。',
      '打掉牠就<b>必定</b>掉你缺的那份道具，試煉即可往下。反過來說：其他職業、或已經拿到道具／過了那步的人，在這裡是<b>等不到</b>牠的（不用白等）。'
    ] },
    { t: '炎魔交付物哪裡拿（騎士／妖精／法師的兌換材料）', lines: ['炎魔之劍／炎魔之爪／炎魔之心：在「魔族神殿」打「炎魔的惡魔」（Lv61），每次<b>掉 3 個</b>。拿回去找迪嘉勒廷，每 1 個換 1 把對應的傳說武器（可重複換）。'] },
    { t: '魔族神殿（完成試煉後開放）', lines: ['進入條件：<b>完成你職業的 50 級試煉</b>。怪物有炎魔系列、墮落的司祭，頭目「墮落」（Lv68，不死）；掉墮落系列裝備（斗篷／盔甲／手套／靴）。<b>在這裡每打一隻怪，「炎魔友好度」+1</b>。'] },
    { t: '炎魔謁見所 → 暗影神殿（終盤）', lines: ['炎魔友好度<b>累積到 1000</b>，開放城鎮「炎魔謁見所」，裡面有製作 NPC（炎魔之影／小惡魔／炎魔鐵匠），能做惡魔系列武器、炎魔的血光斗篷與「暗影神殿鑰匙」。', '暗影神殿鑰匙：在炎魔鐵匠用「魂石碎片 ×10 ＋ 100 萬金幣」製作。', '進「暗影神殿」要兩個條件：<b>持有暗影神殿鑰匙</b>（不會被消耗）＋<b>炎魔友好度 ≥ 1000</b>。裡面頭目「死亡」（Lv70）、「混沌」（Lv70），掉死亡／混沌系列裝備。'] },
    { t: '順帶開放的野外新區域', lines: ['<b>精靈墓穴</b>：頭目「深淵之主」（Lv60），掉深淵戒指與深淵系列素材、技能書。', '<b>古代巨人之墓</b>：頭目「巨大墳墓守護者」（Lv56，會石化）。', '<b>大洞穴隱遁者村莊地區</b>：50 級試煉的樞紐（黑暗妖精將軍、黑暗棲林者、魔族暗殺團都在這出沒）。'] }
  ];
  ...
  function renderQuest(cls) {
    ...
    html += '<div class="m-wiki-sub">🔥 試煉後：新區域與終盤進程</div>' +
