...
(function () {
  ...
  var WEAPON_TRAITS = [
    ...
    { n: '魔擊（力量魔法杖）', d: '普攻有「力量 ÷ 60」的機率追加一次「必定命中且必定重擊」的物理攻擊。只有「力量魔法杖」有。法師選「魔擊精通」時，觸發魔擊必定再對全場敵人各補一次同等傷害的擴散魔擊；且持共鳴／魔爆武器時，共鳴／魔爆的觸發也改為發動魔擊（機率同為力量 ÷ 60）。' },
    ...
    { n: '魔爆（神官魔杖）', d: '施放傷害魔法時依智力觸發引發爆炸（單體魔法：智力 ÷ 100 的機率；全體魔法：智力 ÷ 60 的機率），將「本次魔法傷害的三成」<b>均分</b>給場上所有敵人。代表武器：神官魔杖。法師選「魔擊精通」時，魔爆改為發動<b>魔擊</b>（機率改為力量 ÷ 60、不再引爆均分）。' },
  ...
  var STATS_SECTIONS = [
    { t: '💪 力量（STR）', lines: [
      ...
      '部分武器特性靠力量觸發：力量魔法杖「魔擊」、匕首／矛「出血」的機率都是<b>力量 ÷ 60</b>；屠龍劍「龍的一擊」固定傷害 ＝ 1～力量 ＋ 25。法師選「魔擊精通」時，共鳴／魔爆的觸發也改看<b>力量 ÷ 60</b>。'
    ]},
    { t: '🏹 敏捷（DEX）', lines: [
    ...
    { t: '🔮 智力（INT）', lines: [
      ...
      '魔杖類特性靠智力觸發：魔杖「共鳴」、光箭機率 ＝<b>智力 ÷ 60</b>；神官魔杖「魔爆」＝單體 <b>智力 ÷ 100</b>、全體 <b>智力 ÷ 60</b>（法師選「魔擊精通」時，這兩者改為發動魔擊、機率改看力量 ÷ 60）。'
    ]},
    { t: '🧠 精神（WIS）', lines: [
  ...
  function renderPledge() {
    ...
    out += wCard('🎯 魔物追蹤（想指定／單打特定怪就靠這個）',
      wDesc('想<b>只刷／單打某一隻怪</b>（專刷某掉落）就用這個：先<b>攻下一座城</b>，到城堡裡的追蹤 NPC（<b>奧貝勒／赫特／帝倫</b>）用 <b>50 張王族搜索狀</b>指定某地區的某隻怪（<b>BOSS 不能追</b>）。接下來 <b>8 小時</b>你待在那張圖時，出怪有 <b>50% 機率直接刷成指定那隻</b>。（隱藏狩獵區的怪無法指定。）'));
  ...
  function renderMagic(magicCls) {
    ...
    html += '<div class="m-wiki-note">⚔️ <b>攻擊魔法的實際傷害不只看「威力」骰子。</b>每段傷害 ≈ <b>骰子 ×（1＋階級÷3）×（1＋魔法傷害÷16）</b>，最後扣目標魔防(MR)。<b>階級越高、倍率越大</b>——所以高階魔法即使骰子看起來差不多甚至略低，實際往往更強。<br>例：流星雨(10 階，骰 6~90) 與冰雪暴(8 階，骰 8~80) 平均骰值相近，但把階級係數乘進去後<b>流星雨實際約強 29%</b>。下面每條的「威力」是<b>骰子基礎值</b>，比強度請連階級一起看。</div>';
    if (magicCls !== 'all') {
      var rows = [];
