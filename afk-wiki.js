...
(function () {
  ...
  var WEAPON_TRAITS = [
    ...
    { n: '月光爆裂', d: '攻擊時 8% 機率追加一發「風屬性」<b>魔法</b>傷害。基礎值 ＝ 1~30 ＋（武器強化值 ×2）＋ 魔法傷害，之後照<b>完整魔法傷害流程</b>結算：吃額外魔法點數與武器階級加成、扣目標風屬性抗性與魔防、被破魔減半、屬性相剋時 ×1.4（被剋 ×0.6）。<b>不是無視防禦的固定傷害。</b>代表武器：熾炎天使弓。' },
    ...
    { n: '出血（匕首 / 單手矛）', d: '普攻命中時有「力量 ÷ 60」的機率讓目標流血：每層每秒造成「該擊傷害的 20%」、持續 8 秒，最多疊 5 層（疊滿後新層取代最舊層）。<b>雙手矛只有穿透、不會造成出血</b>。黑暗妖精「出血精通」會讓匕首／單手矛／雙刀都能疊到 10 層、且每層傷害再 +10%（滿 10 層 ＝ +100%），並讓「雙刀」也比照匕首觸發出血（同樣力量 ÷ 60）。代表武器：各種匕首、單手矛、雙刀（雙刀需出血精通）。' },
    ...
    { n: '創傷', d: '一般攻擊命中時 <b>5%</b> 機率讓目標陷入「創傷」：<b>目標受到的所有物理傷害 +5</b>、持續 <b>6 秒</b>、最多疊 <b>2 層</b>（滿層 +10）。加成對<b>你、傭兵、寵物、召喚物</b>的物理攻擊全部生效，等於整隊一起變痛。代表武器：戰士的漆黑之劍。' },
    { n: '重擊即死', d: '打出<b>重擊</b>時，若目標<b>等級比你低且不是頭目</b>，直接<b>即死</b>；<b>每 3 秒最多觸發 1 次</b>，觸發時自己還<b>回復 30 HP</b>。清小怪極快。代表武器：斬首的巨大鐮刀。' },
    { n: '挫傷補正', d: '一般攻擊<b>未命中</b>時改判為「挫傷」，仍造成傷害但<b>不會爆擊</b>。一般的擦傷補正給 <b>50%</b> 傷害，少數武器另外指定比例（如<b>迷宮惡魔的瞥視</b>是 <b>30%</b>，換來 100% 的補正機率）。代表武器：迷宮惡魔的瞥視。' },
    { n: '雙倍一擊', d: '一般攻擊有固定機率讓該擊<b>傷害直接 ×2</b>（與雙刀的「雙刃」是同一類效果，但寫在武器上、不限武器種類）。代表武器：艾爾摩古戰場巨劍（<b>3%</b>）。' },
    { n: '觸發治癒（錫杖）', d: '一般攻擊<b>命中</b>時有機率<b>免費施放治癒法術</b>，而且是<b>治全隊</b>（你、傭兵、寵物、召喚物一起回）。恢復量走正常的治癒公式（吃智力與魔杖加成）。代表武器：鋼鐵僧侶的錫杖（<b>5%</b> 觸發體力回復術）。' },
    { n: '雙屬性法術（魔杖）', d: '攻擊時有機率<b>免費</b>打出一發<b>同時帶兩種屬性</b>的魔法：兩段各自擲骰、各自對照目標的屬性相剋與魔防結算，再加總成一筆傷害，<b>必定命中</b>。代表武器：解除封印的巴風特魔杖（<b>25%</b> 觸發「熾焰地裂術」＝地屬性＋火屬性各一段）。' },
    { n: '不死免疫（盾）', d: '<b>不死類</b>怪物的攻擊<b>完全無效</b>——物理與魔法／狀態技都擋，<b>每 5 秒最多擋 1 次</b>（未命中的攻擊不消耗冷卻）。傭兵裝了也一樣生效、各自計冷卻。代表裝備：十字墓碑盾。' },
    { n: '被重擊反擊（盾）', d: '<b>被敵人打出重擊</b>而且沒被打死時，<b>免費</b>對敵方全體施放一次指定法術。傭兵裝了同樣會發動。代表裝備：長老的黑曜水晶球（施放<b>龍捲風</b>）。' },
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '束縛：把目標「釘在原地」（近戰打不到遠程）', lines: [
      '<b>束縛</b>是一種<b>只擋一般攻擊</b>的控制（<b>不是硬控</b>——被束縛的一方<b>仍能施法、放技能</b>）：中招的一方會「原地不動、搆不到人」。',
      '<b>你（或傭兵）束縛怪</b>：被束縛的怪<b>打不到「手持遠程武器（弓／十字弓）」的你或傭兵</b>——牠那一次一般攻擊直接落空；但<b>近戰目標照樣被打</b>。',
    ...
    { t: '⚔ 經典模式（硬核挑戰）', lines: [
      ...
      '🕊️ <b>損失的經驗可以買回來</b>：亞丁的「<b>聖使阿卡塔</b>」（兩種模式都找得到，但<b>買回經驗只有經典模式有</b>）會記下你每次死亡<b>實際損失</b>的經驗，最多留 <b>10 筆</b>（滿了擠掉最舊的）。每筆可花「<b>死亡時等級 × 死亡時等級 × 1000</b>」金幣，買回<b>該筆損失的一半</b>（例：Lv50 陣亡 → 250 萬金幣換回一半）。買回會正常升級；扣到 0% 的死亡不留紀錄（本來就沒失去經驗）。',
  ...
  var QUEST_BY_CLASS = {
    knight: {
      ...
      trials: [
        ...
        { n: '紅騎士之劍＋盾牌（30 級）', npc: '甘特 ＠說話之島', req: '夏洛伯之爪 ×1、蛇女之鱗 ×1', from: '夏洛伯之爪：夏洛伯（蜘蛛，說話之島、古魯丁、奇岩、海音一帶廣布）；蛇女之鱗：蛇女（海音周邊、鏡子森林、地下通道）。接取後必定掉落', rw: '紅騎士之劍＋紅騎士盾牌（一次全拿）' },
        { n: '勇敢皮帶（45 級）', npc: '馬沙 ＠威頓村', req: '夜之視野 ×1、古代鑰匙 ×1', from: '夜之視野：強盜頭目（奇岩）；古代鑰匙：鋼鐵高崙（歐瑞雪原、水晶洞穴、國境要塞、象牙塔4/5樓）。接取後必定掉落', rw: '勇敢皮帶' }
      ],
      legend: [
    ...
    mage: {
      ...
      trials: [
        ...
        { n: '水晶魔杖（30 級・水晶試煉）', npc: '塔拉斯 ＠象牙塔', req: '不死族的鑰匙 ×1、不死族的骨頭 ×1', from: '鑰匙：骷髏；骨頭：骷髏神射手／骷髏警衛（龍之谷、龍之谷地監1~4樓）。接取後必定掉落', rw: '水晶魔杖' },
        { n: '瑪那魔杖＋斗篷（45 級・瑪那試煉）', npc: '塔拉斯 ＠象牙塔', req: '變形怪的血 ×1', from: '變形怪／變形怪首領（海音·鏡子森林）。接取後必定掉落', rw: '瑪那魔杖＋瑪那斗篷（一次全拿）' }
      ],
      legend: [
    ...
    elf: {
      ...
      trials: [
        ...
        { n: '保護者手套＋精靈水晶（45 級）', npc: '馬沙 ＠威頓村', req: '藍色長笛 ×1、古代鑰匙 ×1', from: '藍色長笛：黑暗精靈（燃柳村·妖魔森林、龍之谷、奇岩、奇岩地監4樓）；古代鑰匙：鋼鐵高崙（歐瑞雪原、水晶洞穴、國境要塞、象牙塔4/5樓）。接取後必定掉落', rw: '保護者手套＋精靈水晶(召喚強力屬性精靈)（一次全拿）' }
      ],
    ...
    dark: {
      ...
      trials: [
        { n: '影子手套（30 級）', npc: '倫得 ＠沉默洞穴', req: '死亡誓約 ×1', from: '強盜（奇岩）。接取試煉後擊殺必定掉落', rw: '影子手套' },
        { n: '影子面具（15 級）', npc: '康 ＠沉默洞穴', req: '妖魔長老首級 ×1', from: '妖魔法師（低階區廣布）。接取後必定掉落', rw: '影子面具' },
        { n: '影子長靴（45 級）', npc: '布魯迪卡 ＠沉默洞穴', req: '雪怪首級 ×1', from: '雪怪（歐瑞、歐瑞雪原、水晶洞穴、國境要塞）。接取後必定掉落', rw: '影子長靴' }
      ]
    },
    illusion: {
      icon: '🔮', name: '幻術士', masteryBoss: '伊弗利特（威頓·火龍窟）',
      trials: [
        { n: '幻術士魔杖＋記憶水晶(立方：燃燒)（15 級）', npc: '希蓮恩 ＠希培利亞村莊', req: '污濁安特的水果 ×1、污濁安特的樹枝 ×1、污濁安特的樹皮 ×1', from: '污染的安特（妖精森林·眠龍洞穴 1~3 樓、妖精森林周邊）。接取試煉後擊殺必定掉落', rw: '幻術士魔杖＋記憶水晶(立方：燃燒)（一次全拿）' },
        { n: '幻術士法書＋記憶水晶(立方：衝擊)（30 級）', npc: '希蓮恩 ＠希培利亞村莊', req: '艾爾摩將軍之心 ×1', from: '艾爾摩將軍（歐瑞、歐瑞雪原、艾爾摩激戰地）。接取後必定掉落', rw: '幻術士法書＋記憶水晶(立方：衝擊)（一次全拿）' },
        { n: '幻術士斗篷（45 級）', npc: '希蓮恩 ＠希培利亞村莊', req: '完成的時間水晶球 ×1', from: '熔岩高崙（威頓·火龍窟）。接取後必定掉落', rw: '幻術士斗篷' }
      ]
    },
    dragon: {
      icon: '🐉', name: '龍騎士', masteryBoss: '飛龍（龍之谷）',
      trials: [
        { n: '龍騎士雙手劍＋龍之護鎧書板（15 級）', npc: '普洛凱爾 ＠貝希摩斯', req: '妖魔搜索文件 ×3', from: '甘地／羅孚／阿吐巴／都達瑪拉妖魔（妖精森林周邊、燃柳村·妖魔森林、眠龍洞穴）。接取試煉後擊殺必定掉落（僅龍騎士）', rw: '龍騎士雙手劍＋龍騎士書板(龍之護鎧)（一次全拿）' },
        { n: '龍鱗臂甲＋血之渴望書板（30 級）', npc: '普洛凱爾 ＠貝希摩斯', req: '妖魔密使首領間諜書 ×1', from: '蛇女（海音周邊、鏡子森林、地下通道）。接取後必定掉落（僅龍騎士）', rw: '龍鱗臂甲＋龍騎士書板(血之渴望)（一次全拿）' },
        { n: '龍騎士斗篷（45 級）', npc: '普洛凱爾 ＠貝希摩斯', req: '雪怪之心 ×10', from: '雪怪（歐瑞、歐瑞雪原、水晶洞穴、國境要塞）。接取後必定掉落（集滿 10 個即停）', rw: '龍騎士斗篷' }
      ]
    },
    warrior: {
    ...
    royal: {
      ...
      trials: [
        ...
        { n: '君主的威嚴＋魔法書(呼喚盟友)（30 級）', npc: '甘特 ＠說話之島', req: '村民的遺物 ×1', from: '巨大兵蟻（風木·沙漠、螞蟻洞窟 1~2 樓）。接取後必定掉落（僅王族）', rw: '君主的威嚴（防禦(AC) -2、全六屬性 +1）＋魔法書(呼喚盟友)（一次全拿）' },
  ...
  var TRIAL_50 = {
    knight: { n: '騎士 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '兩階段依序交付：①丹特斯的召書 ×1 → ②精靈的私語 ×10', from: '丹特斯的召書：黑暗妖精將軍 1%（燃柳村·大洞穴隱遁者村莊／拉斯塔巴德正門／拉斯塔巴德·魔獸訓練場）；精靈的私語：在「燃柳村·精靈墓穴」打任何怪 1% 掉', rw: '完成階段任務後開放「魔族神殿」。最終試煉：在魔族神殿打「炎魔的惡魔」（Lv61）取得「炎魔之劍」（最終兌換階段必定掉落）×1 交付 → 一次領取全部獎勵：傳說武器「黑燄之劍」＋「勇氣長靴」（每個角色僅能完成一次）' },
    elf: { n: '妖精 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '兩階段依序交付：①古代黑妖之秘笈 ×1 → ②密封的情報書 ×1', from: '古代黑妖之秘笈：巨大兵蟻 1%（風木領域：沙漠／螞蟻洞窟 1~2 樓）；密封的情報書：在「燃柳村·大洞穴隱遁者村莊地區」打「魔族暗殺團」必掉。魔族暗殺團是特殊怪、不常駐，只有你正卡在這一步（缺密封的情報書）時，在這張圖每打一隻怪才有 1% 機率讓牠出現（一次只會有一隻）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：在魔族神殿打「炎魔的惡魔」（Lv61）取得「炎魔之爪」（最終兌換階段必定掉落）×1 交付 → 一次領取全部獎勵：傳說「赤焰之弓」＋「赤焰之劍」＋「賽菲亞長靴」（每個角色僅能完成一次）' },
    mage: { n: '法師 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '一階段：交付 間諜報告書 ×1', from: '間諜報告書：在「燃柳村·大洞穴隱遁者村莊地區」打「魔族暗殺團」必掉。魔族暗殺團是特殊怪、不常駐，只有你正卡在這一步（缺間諜報告書）時，在這張圖每打一隻怪才有 1% 機率讓牠出現（一次只會有一隻）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：在魔族神殿打「炎魔的惡魔」（Lv61）取得「炎魔之眼」（最終兌換階段必定掉落）×1 交付 → 一次領取全部獎勵：傳說武器「瑪那水晶球」＋「瑪那長靴」（每個角色僅能完成一次）' },
    warrior: { n: '戰士 50 級試煉', npc: '多文 ＠海音（需等級 50）', req: '第一階段：交付 神秘魔杖 ×5', from: '神秘魔杖：思克巴／思克巴女皇（龍之谷地監 4~6 樓、傲慢之塔 11~20 樓）。接取後必定掉落（僅戰士、集滿 5 個即停）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：交付 神秘慎重藥水 ×1（魔族神殿打「墮落的司祭」，最終兌換階段必定掉落）→ 領取「大匠的斧頭」（單手鈍器，對不死／狼人加成、近距離傷害 +1；每個角色僅能完成一次）。戰士不走炎魔交付物' },
    royal: { n: '王族 50 級試煉', npc: '迪嘉勒廷 ＠象牙塔（需等級 50）', req: '第一階段：交付 調職命令書 ×1', from: '調職命令書：小惡魔 1%（傲慢之塔 21~30 樓；王族限定）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：在魔族神殿打「炎魔的惡魔」（Lv61）取得「炎魔之心」（最終兌換階段必定掉落）×1 交付 → 一次領取全部獎勵：傳說「黃金權杖」（王族單手劍、反擊／居合）＋「神意長靴」（每個角色僅能完成一次）' },
    dark: { n: '黑暗妖精 50 級試煉', npc: '布魯迪卡 ＠沉默洞穴（需等級 50）', req: '一階段：交付 混沌鑰匙 ×1', from: '混沌鑰匙：黑暗棲林者 1%（燃柳村·大洞穴隱遁者村莊／拉斯塔巴德·魔族神殿）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：在魔族神殿打「墮落的司祭」取得「墮落鑰匙」（最終兌換階段必定掉落）×1 交付 → 領取傳說「死亡之指」（每個角色僅能完成一次）' },
    illusion: { n: '幻術士 50 級試煉', npc: '希蓮恩 ＠希培利亞村莊（需等級 50）', req: '第一階段：交付 時空裂痕碎片 ×100', from: '時空裂痕碎片：底比斯／提卡爾系列怪掉落（時空裂痕領域；多為 10%，固定數量）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：交付 翼龍之血 ×5（遺忘之島本島打「遺忘之島飛龍」，最終兌換階段必定掉落·集滿即停）→ 領取傳說武器「藍寶石奇古獸」（每個角色僅能完成一次）' },
    dragon: { n: '龍騎士 50 級試煉', npc: '普洛凱爾 ＠貝希摩斯（需等級 50）', req: '第一階段：交付 時空裂痕碎片 ×100', from: '時空裂痕碎片：底比斯／提卡爾系列怪掉落（時空裂痕領域；多為 10%，固定數量）', rw: '完成階段任務後開放「魔族神殿」。最終試煉：交付 靈魂之火灰燼 ×1（傲慢之塔 41~50 樓打「火焰之靈魂」，最終兌換階段必定掉落）→ 領取傳說「消滅者鎖鏈劍」（每個角色僅能完成一次）' }
  };
  ...
  var SETS = [
    ...
    { n: '司祭苦行套裝（5 件遺物）', pcs: 5, items: '司祭的無眼頭飾、斷指護手、鎖喉頸圈、腐爛長袍、殘破草鞋', eff: '防禦(AC) -50、魔防 +50、HP上限 +300、MP自然恢復 +30、近／遠／魔法爆擊率 各 +5%、近／遠／魔法爆擊傷害 各 +50%。五件都是遺物（無法強化、不帶詞綴），各由「墮落的司祭」一～五階怪 0.0001% 掉落；每件單穿還各自免疫一種異常（盲／麻痺／沉默／中毒／緩速）。' }
  ];
  ...
  function attrMagicTableHtml() {
    ...
    return rows.length ? wTbl(['武器屬性', '可能抽到的魔法（括號＝一星的觸發率；二星 ×2、三星 ×3）'], rows) : '';
  }
  ...
  var ENHANCE_SECTIONS = [
    { t: '強化（把裝備 +1 升級）', lines: [
      ...
      '<b>+1~+10 的加成</b>：武器→每階 額外傷害 +1、額外命中 +1（弓加在遠距離）；防具→每階 防禦(AC) 再 -1（越低越好，部分另加魔防）；飾品看部位——<b>戒指</b>每階 防禦(AC) -1、<b>項鍊</b>每階 魔防 +3、<b>腰帶</b>每階 負重上限 +20。（+11 以上的規則不同，見下一張卡）',
      '<b>武器成功率</b>（達安定值後；安定值 6 的武器 +5 以內 100%）：<b>+8 以前 1/3（約 33%）成功、其餘爆裝</b>；<b>+9 起</b>變成三種結果——<b>1/6（約 17%）成功、1/6 無事發生（卷軸消耗但裝備不變不爆）、4/6（約 67%）爆裝</b>。',
      '<b>防具成功率</b>（有安定值的，如安定值 4 或 6）：達安定值後為 <b>1÷目前強化值</b>——+6→約 17%、+7→約 14%、+10→10%、+14→約 7%。',
      '<b>防具（安定值 0）與飾品成功率</b>：+0→50%、之後為 <b>1÷(強化值×2)</b>——+1→50%、+2→25%、+3→約 17%、+4→12.5%。',
      '特殊卷軸：「祝福的」卷軸成功時一次多加幾階——<b>+2 以下各 1/3 機率 +1／+2／+3</b>、<b>+3~+5 各半機率 +1／+2</b>、<b>+6 以上就只 +1</b>（等同一般卷軸；一樣要先過成功率，失敗照爆裝）。「詛咒的」卷軸 100% 讓強化值 −1、不爆裝，<b>最低可掉到 −1</b>。',
      '<b>遺物無法強化</b>：遺物（藍字裝備）不能吃任何強化卷軸，也永遠不會帶祝福／詛咒或屬性／遠古詞綴（見「裝備」分頁的遺物說明）。'
    ]},
    { t: '強化上限（+11 以上）', lines: [
      '<b>強化上限依裝備類型不同：武器最高 +15、防具 +15、飾品 +5。</b>達到上限後就無法再強化（強化按鈕會隱藏、卷軸也選不到它），名稱照常顯示「+上限值」。',
      '<b>武器 +11~+15</b>：每階仍繼續加 +1 固定傷害（達 +15 時額外傷害共 +15）；額外命中的加速度變快，<b>+11~+15 的總命中為 +11／+12／+14／+16／+18</b>。',
    ...
    { t: '詞綴怎麼來', lines: [
      '<b>祝福</b>：打怪／製作／血盟掉落有 1% 機率直接帶「祝福的」（在「席琳的世界」擊殺時 ×3＝3%）；強化卷軸取得時也各有 1% 變成祝福／詛咒卷軸。（<b>黑市商品也一樣有 1%</b>，席琳的世界 ×3、瘋狂的席琳世界 ×5；但它是<b>上架那一刻就擲好</b>的，買下去只是交付既定結果，讀檔重買不會變）',
      '<b>遠古系：無法靠打怪／製作隨機取得</b>，只能用象牙塔「碧恩」的『賦予祝福卷軸』施法。每施法一次固定消耗 1 張卷軸，並在「屬性／遠古／祝福」三格裡隨機抽一格動手（各 1/3）：那一格原本沒詞綴→<b>附加</b>；原本就有、又抽到同一種→<b>把裝備上原本那個詞綴移除</b>（所謂「消失」消失的是<b>裝備上的這個詞綴</b>，不是卷軸、也不是裝備本身；卷軸無論結果都會用掉、裝備不會不見）；原本有、抽到不同種→<b>換成新抽到的</b>。抽中哪一格、結果如何都無法指定。',
      '<b>屬性詞綴走另一條路</b>：拿<b>該屬性的「武器強化卷軸」</b>（火之／水之／風之／地之，由對應屬性的怪掉落）去找<b>碧恩</b>賦予。'
      + '<b>每次成功率只有 7%</b>，失敗只消耗卷軸、<b>武器不會消失</b>；成功則覆蓋原本的屬性詞綴。'
      + '要衝到<b>第四階武器得先 +10</b>、<b>第五階得先 +11</b>（不夠不會消耗卷軸）。'
      + '<b>例外</b>：本來就<b>不能強化</b>的非遺物武器（<b>古老的劍</b>、<b>古老的巨劍</b>）永遠是 +0，所以<b>免這道門檻</b>，可以一路衝到第五階。',
      '詛咒的裝備不能再被祝福，要先清掉詛咒：用「解除詛咒的卷軸」，或直接付 <b>100 萬金幣</b>（都是找碧恩處理）。'
    ]},
    { t: '第五階武器再進一步：屬性附加魔法（★）', lines: [
      '武器的屬性<b>已經是第五階</b>之後，同一種屬性的卷軸還能繼續拿去找<b>碧恩</b>——這時不再升階，改成幫武器<b>附加一個會自動觸發的魔法</b>。',
      '<b>成功率 1%</b>（比升階的 7% 更難），失敗一樣只消耗卷軸、武器不會怎樣。成功時<b>從該屬性的 5 種魔法裡隨機抽一個</b>，不能指定。',
      '<b>星級怎麼上去</b>：抽到<b>和現在同一個</b>魔法 → <b>升一星</b>，<b>觸發率直接乘上星數</b>（最高 <b>★★★</b>＝三倍）；抽到<b>不同</b>的魔法 → 換成新魔法、<b>退回一星</b>。所以想堆星只能一直賭同一個。',
      '<b>不是每把武器都能附</b>：<b>本身就有「攻擊／命中時機率觸發」效果的武器不行</b>（例如自帶毒咒、灼燒、額外施法那些），<b>遺物也不行</b>。能不能附，看碧恩那邊按下去有沒有提示「此武器無法附加魔法」。',
      '⚠️ <b>之後若被賦予別的屬性成功，附加魔法會跟著消失</b>（連星級一起歸零）。',
      '附上魔法後，武器名稱前面會多出 <b>★</b>，物品說明也會寫出觸發率。'
  ...
  var KINGROOM_SECTIONS = [
    ...
    { t: '房內限制與離線', lines: [
      ...
      '⚠️ 軍王之室<b>不列入離線收益</b>：關掉網頁再回來，這段時間<b>完全沒有產出</b>（詳見「離線收益」分頁的排除清單）。想掛整晚要先移到一般狩獵圖。',
      '把分頁<b>切到背景但不關網頁</b>則不受影響——回到遊戲會把那段時間的戰鬥一格一格補跑完，照樣「打贏→5 秒燒 1 鑰匙→重生」一輪輪跑，鑰匙用完自動傳回最近待過的村莊。'
    ]}
  ];
  ...
  function tabHTML(key, cls) {
    ...
    if (key === 'offline') return renderOffline();
    return '';
  }
  ...
  var SEARCH_SOURCES = [
    ...
    { key: 'offline', cls: false, label: '離線收益' },
  ...
  function renderPets() {
    ...
    return note
      + wCard('① 怎麼抓：用誘捕道具，然後把牠打死',
          ...
          + wDesc('四隻蜥蜴的強度<b>以同等級的黃金龍為基準</b>再各自乘上倍率：破滅（普攻最高、無視部分傷害減免）、災厄（最耐打，會自己加傷害減免，也最容易被怪盯上）、詛咒（魔法最強，冰雪暴有機率冰凍）、厄運（普攻與魔法都偏高）。牠們的第二招都是<b>必中的持續傷害</b>（灼燒／出血／中毒，每秒固定傷害）。'))
      ...
      + wCard('③ 戰鬥：牠自己會打，也會幫你挨打',
          ...
          + wDesc('寵物<b>挨怪普攻時另有一段隨機減傷</b>：上限＝（10 − 寵物防禦(AC) ＋ 隊伍AC加成）÷ N，<b>N 依寵物類型＝物理 3／特殊 4／魔法 5</b>（物理型減得最多），實際值在「上限的三分之一 ~ 上限」之間隨機。所以<b>把寵物的防禦(AC) 壓低不只少被命中，還會連帶提高這段減傷</b>。')
      ...
      + wCard('⑤ 進化（Lv30 以上，限一般型態）',
          ...
          + wDesc('另外，打<b>四大龍</b>（安塔瑞斯／法利昂／巴拉卡斯／<b>林德拜爾</b>）時，各有 <b>10%</b> 機率掉「<b>頑皮幼龍蛋</b>」、另 <b>10%</b> 掉「<b>淘氣幼龍蛋</b>」（兩顆<b>各自獨立</b>判定、可重複拿）。蛋可以<b>直接孵化</b>（寵物保管沒滿時）：<b>頑皮幼龍蛋→頑皮龍</b>、<b>淘氣幼龍蛋→淘氣龍</b>（各自定向，不再隨機）；也可以<b>存進倉庫</b>或賣掉。')
  ...
  function renderPoly() {
    ...
    if (typeof CONTROL_ONLY_POLY_FORMS !== 'undefined' && CONTROL_ONLY_POLY_FORMS.length) {
      h += '<div class="m-wiki-sub">💍 變形控制戒指限定（變形卷軸抽不到）</div>';
      ...
      h += wDesc('這兩個型態只能用<b>變形控制戒指</b>指定，<b>變形卷軸不會抽到</b>。它們的<b>攻擊施法與輔助施法（治癒／淨化／轉換／輔助）速度是分開的</b>——輔助放得比攻擊快。<b>夏納</b>會保留你原本的職業外觀；<b>真夏納</b>有 16 種職業性別各自的專屬動態，普攻速度另依「職業性別 × 手上武器」查表決定。');
    }
  ...
  function renderAlly() {
    ...
    var c2 = card('② 戰力＝招募快照，但會跟你一起升級', { lines: [
      '<b>招募當下的快照</b>：用他招募時的裝備／技能／精通／套裝／配點結算戰力（<b>吃他自己的精通、不吃你的</b>）。事後幫他換裝改精通不會自動跟上——要在公會點<b>「重新招募」</b>才更新（重招較便宜：Lv1 約 <b>1/10</b>、Lv50 約 <b>1/5</b>、Lv100 約 <b>1/2</b>）。回村或登入也會<b>自動刷新一次</b>隊員資料。<b>收集冊加成吃「你（招募者）」的</b>：卡片／裝備／道具收集冊與魔法娃娃的全收集加成，招募與升級重算時都以你當下的收集進度計入傭兵。',
      ...
      '💰 <b>組隊還讓掉落與金幣翻倍</b>：<b>金幣與每件掉落機率都會乘上「有效隊伍人數」＝主玩家＋未倒地傭兵（最多 8 人）</b>——帶滿 3 名傭兵＝<b>×4</b>、王族帶滿 7 名＝<b>×8</b>（單件掉落機率最高補到 100%）。這是把傭兵拉滿的最大好處。金幣與掉落全歸你主角。',
      '<b>經驗還你角色</b>：解散／重招／你回村時，傭兵累積的經驗記成「待領帳本」，<b>那角色下次登入或回村自動一次領取</b>（借去當傭兵不虧）。'
    ]});
    ...
    var c5 = card('⑤ 會挨打、會倒地（不是永久死）', {
      html:
        ...
        desc('⚙️ <b>開戰後仇恨會隨「造成的傷害」累積</b>：上表只是<b>開打瞬間</b>的基礎權重，之後<b>輸出越高的人越會把怪吸過去</b>（近戰職業累積得快、遠程／施法慢一些，累積值約 <b>10 秒</b>衰退一半）。所以高輸出的脆皮打久了也可能被鎖定，前排坦要靠<b>血厚耐打</b>撐住，不是光靠站前面。') +
  ...
  function renderMode() {
    ...
    var c1 = card('📉 經驗 · 金幣 · 掉率 · 死亡', tbl(
      ...
      + '<div class="m-wiki-desc">・<b>兩個地方死掉不扣經驗</b>：<b>攻城區</b>與<b>時空裂痕</b>裡陣亡都不算懲罰。</div>');
  ...
  var ANTHARAS_SECTIONS = [
    { t: '怎麼進、每天能打幾次', lines: [
      ...
      '<b>相同模式（一般／經典）所有角色「合計」每天只能通關 1 次</b>——不是每個角色各一次，是整個模式共用一次。每天 <b>UTC+8 凌晨 12 點</b>重置。',
    ...
    { t: '最終戰：被侵蝕的安塔瑞斯（三段變身）', lines: [
      ...
      '<b>只有最終階「瘋狂安塔瑞斯」會死亡並結算掉落</b>——擊敗牠＝通關，自動送回威頓村、記下相同模式今天已通關。',
      '牠會放劇毒噴吐（中毒）、巨岩炮／地裂術、集體衝暈、毀滅隕石等<b>全體技</b>，愈後面階段愈兇；免疫中毒（安塔瑞斯系列盔甲）與抗地屬性會很有用。'
    ]},
    { t: '助戰者：借別的角色來加持自己（最多 4 位）', lines: [
      ...
      '<table style="width:100%;border-collapse:collapse;margin:4px 0;font-size:13px;color:#cbd5e1;"><thead><tr><th style="text-align:left;padding:4px 6px;border-bottom:1px solid #475569;">職務</th><th style="text-align:left;padding:4px 6px;border-bottom:1px solid #475569;">給你的加成</th></tr></thead><tbody>'
        ...
        + '</tbody></table>',
      '<b>每次跟多魯嘉貝爾對話都會依來源角色的最新存檔刷新</b>；來源角色被刪除或在同一格重建，助戰會自動解除。<b>已受僱為傭兵的角色不能當助戰者</b>，同一角色也不能同時擔任兩種職務。助戰限制只看你目前這隻角色的傭兵名單，不影響同模式其他角色。'
    ]},
    ...
    { t: '安塔瑞斯裝備怎麼做（威頓村・米米）', lines: [
      ...
      '<b>安塔瑞斯系列盔甲</b>（力量／魅惑／泉源／霸氣，分不同職業穿）＝古代地龍鱗盔甲 ×1 ＋ 安塔瑞斯之心 ×2 ＋ 材料。共通效果：地屬性抗性 +50、免疫中毒、傷害減免 +3（強化 +7 起每 +1 再 +1、最高 +6），另各有專屬的 HP／MP 恢復與屬性加點。'
    ]},
    { t: '掉落一覽在哪查', lines: [
  ...
  function renderPledge() {
    ...
    out += wCard('🏴 NPC 血盟（世界上還有另外 ' + NPCCLAN + ' 個盟）',
      ...
      wDesc('⚔️ <b>團戰</b>：對某個交戰中、<b>仇恨超過 80</b> 的盟，在野外每打死一隻一般怪有 <b>1%</b> 機率被他們包圍——場上清空換成一整批敵盟玩家，<b>擊退 20~50 名</b>就贏，敵人還會<b>再高 3 級</b>。不想打就<b>直接離開這張圖</b>，團戰即結束。（村莊、攻城區、純頭目圖、軍王之室不會發生。）') +
      wDesc('🕊️ <b>對方會求饒</b>：某個盟士氣<b>第一次掉到 100 以下</b>時會派盟主密語求和（之後每 10~30 分再密一次），此時仇恨歸零、暫時停火。只有<b>王族</b>能回應：<b>接受</b>＝解除敵對（但<b>宣戰要滿 24 小時</b>才准停戰）；<b>嘲諷</b>＝對方士氣<b>回 +200</b>、仇恨拉滿並重新開戰。') +
    ...
    out += wCard('🎯 魔物追蹤（想指定／單打特定怪就靠這個）',
      wDesc('想<b>只刷／單打某一隻怪</b>（專刷某掉落）就用這個：先<b>攻下一座城</b>，到城堡裡的追蹤 NPC（<b>奧貝勒（肯特城）／赫特（風木城）／帝倫（海音城）</b>）花 <b>100,000 金幣</b>指定某地區的某隻怪（<b>BOSS 不能追</b>）。接下來 <b>8 小時</b>你待在那張圖時，出怪有 <b>50% 機率直接刷成指定那隻</b>。（隱藏狩獵區的怪無法指定。）') +
  ...
  function renderRelicMarket() {
    ...
    out += wCard('🧍 叫賣的玩家（收購者）',
      wTbl(['項目', '規則'], [
        ...
        ['不會出現的地方', '席琳神殿、肯特城／風木城／海音城（三座城堡）、炎魔謁見所']
      ]) +
    ...
    out += wCard('🛒 潘朵拉黑市（陳列與收購單）',
      wTbl(['項目', '規則'], [
        ...
        ['會不會祝福', '<b>上架那一刻就決定好了</b>——1% 機率是「祝福的」（席琳的世界 ×3、瘋狂的席琳世界 ×5）。買下去只是把既定結果交給你，<b>不是付錢當下才擲</b>']
      ]) +
  ...
  function renderPvp() {
    ...
    out += wCard('🔴 PVP 開關與遭遇',
      ...
      wDesc('⚠️ <b>和 NPC 血盟交戰時，PVP 開關會被鎖成開啟</b>，而且遭遇率不一樣：'
        + '<b>雙方互宣</b>＝野外遭遇率 <b>3%</b>，其中 <b>80%</b> 是互宣的敵盟；'
        + '<b>你單方面宣戰</b>＝遭遇率仍是 1%，其中 <b>50%</b> 是該敵盟；'
        + '<b>對方單方面宣戰</b>＝就算你把 PVP 關掉，野外仍有 <b>1%</b> 會遇到該敵盟。詳見「血盟」。'));
    ...
    out += wCard('🌐 世界頻道（跟假玩家聊天）',
      ...
      wDesc('點對方名字可以<b>嘲諷</b>或<b>感謝</b>。嘲諷之後對方可能翻臉來野外追殺你，機率<b>看他的性向</b>：') +
      wTbl(['對方性向', '被追殺的機率'], [
        ['<b>邪惡（紅名）</b>', '<b>100%</b>'],
        ['中立', '<b>50%</b>'],
        ['<b>正義</b>', '<b>20%</b>']
      ...
      wDesc('⚠️ 頻道上的名單<b>只存在當下</b>——重新整理頁面就換一批人，只有「嘲諷記仇」會留在存檔裡。'));
  ...
  // 離線收益(本檔手動維護;上游 js/27-offline-rewards.js)。數字全部對照該檔開頭的 OFFLINE_* 常數與
  //   _offlineValidHuntMap / _offlineBossPlan / _offlineRollMobLoot 的實際判斷,不抄遊戲內的說明文字。
  //   何時要更新:上游改效率/上下限/可結算地圖清單/頭目遭遇率/存活推算(_offlineSurvivalPlan)/頭目房一輪成本,
  //   或改動「背景分頁怎麼補」「離線資格怎麼鎖」(_offlineLockAfterDeath)時。
  // 頭目房每輪要燒的入場道具:與 js/27 的 _offlineBossRoomCostId 同一套判斷(KING_ROOMS.key → 預設軍王的鑰匙;
  //   聖地/會議廳走 SANCT_RESPAWN_COST;三座龍窟兩張表都沒有＝不用道具),清單直接讀 PURE_BOSS_MAPS 免得漏圖。
  function bossRoomRows() {
    if (typeof PURE_BOSS_MAPS === 'undefined' || !Array.isArray(PURE_BOSS_MAPS)) return [['（讀不到資料）', '—']];
    return PURE_BOSS_MAPS.map(function (m) {
      var id = '';
      try {
        if (typeof KING_ROOMS !== 'undefined' && KING_ROOMS[m]) id = KING_ROOMS[m].key || 'item_king_key';
        else if (typeof SANCT_RESPAWN_COST !== 'undefined' && SANCT_RESPAWN_COST[m]) id = SANCT_RESPAWN_COST[m];
      } catch (e) {}
      var nm = '';
      try { nm = id && DB.items[id] ? DB.items[id].n : id; } catch (e) { nm = id; }
      return [esc(mapTitleOf(m)), id ? ('<b>' + esc(nm) + '</b> × 1') : '<b>不用道具</b>'];
    });
  }

  function renderOffline() {
    var out = '<div class="m-wiki-note">關掉網頁去睡覺，回來還是有收穫。遊戲會記住你<b>最後在哪張圖、打得多快</b>，再照這個速度把離線那段時間的收益補給你。<b>注意「離線」＝真的把網頁關掉</b>；只是切到別的分頁不算離線（見最下面）。</div>';

    out += wCard('📋 基本規則',
      wTbl(['項目', '數值'], [
        ['結算效率', '<b>70%</b>（照你最近的實戰速度打七折）'],
        ['最短離線時間', '<b>1 分鐘</b>（更短不結算）'],
        ['最長結算時間', '<b>12 小時</b>（離線再久也只算 12 小時）'],
        ['要先有「實戰樣本」', '離線前在<b>同一張圖</b>至少打滿 <b>15 秒</b>且<b>擊殺 3 隻</b>以上'],
        ['最後一擊要夠近', '關網頁前 <b>5 分鐘</b>內要有擊殺（掛在原地發呆不算數）'],
        ['記幾張圖', '最多保留<b>最近 5 張</b>圖的樣本，回到哪張圖就用哪張的'],
        ['還要有「資格」', '<b>死掉就失效</b>——線上死、離線死都算；<b>再打倒任何一隻頭目</b>就解開（資格鎖住的期間連樣本都不會記）']
      ]));

    out += wCard('🎁 離線會拿到什麼',
      wTbl(['會給', '不會給'], [
        ['<b>經驗</b>（等級 100 就不再給）、<b>金幣</b>', '<b>PVP</b> 相關的一切（不會遭遇玩家 NPC）'],
        ['<b>寵物經驗</b>、<b>傭兵經驗</b>', '任務專用道具與<b>活動事件</b>'],
        ['一般<b>掉落物</b>與<b>怪物卡片</b>（掉率倍率照常吃）', '需要你手動操作才會發生的事'],
        ['<b>性向值</b>（每殺 1 隻 +1，跟線上一樣）', '——']
      ]) +
      wDesc('掉落照樣吃三種倍率：<b>席琳的世界 ×3</b>、<b>瘋狂的席琳世界 ×5</b>、<b>恩賜 ×10</b>；黑水晶、銀礦、區域加成道具那些「跟著地圖或技能走」的額外掉落也一起結算。') +
      wDesc('回到遊戲時會跳一張<b>結算表</b>，列出這段時間的經驗、金幣、擊殺數、頭目數、掉落物與卡片數量。'));

    out += wCard('💀 離線也會死（撐不住就停在死掉那一刻）',
      wDesc('遊戲平常就在記你<b>在那張圖有多耐打</b>：每秒挨多少傷、回多少血、多久喝一次藥、在那張圖死過幾次。離線結算就照這些數字往下推——撐得住就一路打完，撐不住就<b>停在推算出來的死亡時刻</b>，之後的時間<b>一毛都不算</b>。') +
      wTbl(['項目', '規則'], [
        ['怎麼判死', '<b>挨打速度 −（自然回血 ＋ 喝藥回血）</b>；淨扣血把 HP 扣到 0 就算死在那一刻'],
        ['藥水會真的扣', '照你平常的頻率喝，<b>從背包實扣</b>。算數的治療藥水有<b>紅色藥水／橙色藥水／白色藥水／安特的水果</b>四種'],
        ['藥水喝完之後', '只剩<b>不靠藥水</b>的回血撐著，通常撐不了多久'],
        ['死過的圖更容易死', '你在那張圖<b>死過幾次</b>也會記下來換成每小時死亡率一起抽——就算血量算得過，也可能因為這個死'],
        ['死掉之後', '角色<b>真的變成死亡狀態</b>（HP 歸 0，召喚獸與被魅惑的怪都消失），要復活才能繼續；<b>離線資格同時失效</b>']
      ]) +
      wDesc('結算表會直接寫「<b>戰鬥中死亡</b>」、撐了多久，以及這趟<b>喝掉幾瓶藥水</b>。想掛整晚，離線前記得<b>把藥水補足</b>、選一張你打起來輕鬆的圖。'));

    out += wCard('👹 離線也會打頭目（但有條件）',
      wDesc('離線結算<b>只會安排「你在那張圖真的親手打贏過」的頭目</b>——沒打贏過的不會憑空出現。') +
      wTbl(['項目', '規則'], [
        ['遭遇機率', '每殺 1 隻一般怪有 <b>1%</b> 機率遇上一次頭目；<b>長老之室</b>提高到 <b>5%</b>'],
        ['要花時間', '照你當初打贏牠的<b>平均耗時</b>扣，扣掉的時間會從一般狩獵時間裡讓出來'],
        ['獎勵', '經驗、金幣、寵物與傭兵經驗、掉落都照那隻頭目<b>你實際打贏時的平均值</b>給'],
        ['記幾隻', '每張圖最多記 <b>40 種</b>頭目、<b>80 種</b>一般怪的資料']
      ]));

    out += wCard('👑 頭目房也能離線掛（要燒入場道具）',
      wDesc('<b>整張圖只有頭目</b>的房間（龍窟、軍王之室、祭壇、聖地）走另一套算法：不看一般怪速度，而是照你<b>打贏那些頭目的實際耗時，一輪一輪重複刷</b>。') +
      wTbl(['項目', '規則'], [
        ['先決條件', '那張圖的<b>每一隻頭目都要親手打贏過</b>——只要有一隻沒紀錄，整張圖就不結算'],
        ['一輪是什麼', '把那張圖的頭目<b>各殺一次</b>'],
        ['一輪要多久', '<b>5 秒 ＋ 最慢那隻的平均擊殺時間</b>'],
        ['能跑幾輪', '離線時間 × <b>70%</b> ÷ 一輪耗時（湊不滿一輪的零頭不算）'],
        ['要燒入場道具', '<b>每一輪扣 1 個</b>（下表）；<b>道具不夠就只跑到用完為止</b>'],
        ['拿得到什麼', '經驗、金幣、寵物與傭兵經驗、掉落都照<b>你實際打贏時的平均值</b>給，每輪每隻各算一次']
      ]) +
      wDesc('各房間每輪要燒的東西：') +
      wTbl(['頭目房', '每輪消耗'], bossRoomRows()));

    out += wCard('🚫 這些地方不會有離線收益',
      wTbl(['地點／狀態', '為什麼'], [
        ['村莊與安全區', '本來就沒怪'],
        ['<b>攻城區</b>（含攻城進行中）', '攻城是限時活動，不能離線刷'],
        ['<b>傲慢之塔</b>各層（含攀登中）', '計時／闖關型，離線續跑等於刷榜'],
        ['<b>時空裂痕</b>戰鬥圖（含挑戰中）', '同上，是限時挑戰'],
        ['角色已死亡', '倒著就沒有產出']
      ]) +
      wDesc('⚠️ 這幾張圖<b>離線回來就是 0 收益</b>，不是「算比較少」。想掛整晚，關網頁前記得先移到一般狩獵圖或上面那種頭目房。'));

    out += wCard('🔀 切分頁 ≠ 離線',
      wTbl(['你做了什麼', '遊戲怎麼處理'], [
        ['<b>切到別的分頁／縮到最小</b>（網頁還開著）', '戰鬥<b>在背景就一直照跑</b>（每秒推進一次），收益是<b>全額 100%</b>，掉落、卡片、任務計數都跟你一直看著螢幕一樣'],
        ['<b>真的關掉網頁</b>', '走上面那套<b>七折</b>的離線結算'],
        ['<b>按「回選角」回到選角畫面</b>', '當場存檔，並<b>從按下那一刻開始算離線</b>；再進入同一個角色時，停在選角畫面的這段時間照<b>七折</b>結算（資格條件與關網頁相同）']
      ]) +
      wDesc('所以想拿滿收益，<b>把分頁留著切到背景</b>比關掉划算；回到遊戲時只補「背景最後沒跑完的那一小段」，補完會看到「⏩ 掛機補跑完成」的訊息，把補上的時間與獲得一次列給你。補的量比較大時，畫面下方會出現<b>補跑進度條</b>，跑完自動消失。') +
      wDesc('⚠️ 背景照跑的前提是<b>瀏覽器沒把分頁整個凍結</b>（省電模式、記憶體不足回收都可能凍結）。真的被凍住那段時間會在你回到遊戲時一次補回來，不會不見。') +
      wDesc('如果你是<b>在背景狀態下直接關掉網頁</b>，關頁前那段背景時間會另外記著、下次載入補算，離線的七折只從<b>真正關頁那一刻</b>才開始。'));
  ...
  var MAGIC_FACT = {
    ...
    sk_elf_worldtree: ['被動：在「區域額外掉落」地圖(妖精森林周邊、眠龍洞穴 1~3 樓等)殺怪，精靈玉掉率 20%→30%、粗糙的米索莉塊與元素石 2%→3%'],
