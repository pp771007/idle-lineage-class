...
(function () {
  ...
  function renderOffline() {
    ...
    out += wCard('🔀 切分頁 ≠ 離線',
      wTbl(['你做了什麼', '遊戲怎麼處理'], [
        ['<b>切到別的分頁／縮到最小</b>（網頁還開著）', '回來時會<b>把那段時間的戰鬥一格一格重新跑過一遍</b>，收益是<b>全額 100%</b>，掉落、卡片、任務計數都跟你一直看著螢幕一樣'],
        ['<b>真的關掉網頁</b>', '走上面那套<b>七折</b>的離線結算']
      ]) +
      wDesc('所以想拿滿收益，<b>把分頁留著切到背景</b>比關掉划算；回到遊戲時會看到「⏩ 掛機補跑完成」的訊息，把補上的時間與獲得一次列給你。') +
