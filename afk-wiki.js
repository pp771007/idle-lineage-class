...
(function () {
  ...
  var EFFECT_OVERRIDE = {
    ...
    sk_summon: '召喚一隻生物為你作戰，等級越高召喚到的生物越強；每輪攻擊段數＝魅力÷6（無條件捨去，即每 6 點魅力多打一段，魅力 60 時最多 10 段），命中與傷害也隨魅力提升，有「召喚精通」時命中傷害判定改用魅力×1.2。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
    sk_zombie: '造出一隻人形殭屍隨從替你作戰；每輪攻擊段數＝魅力÷6（無條件捨去，即每 6 點魅力多打一段，魅力 60 時最多 10 段），命中與傷害也隨魅力提升，有「召喚精通」時命中傷害判定改用魅力×1.2。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
