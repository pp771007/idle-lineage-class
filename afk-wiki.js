...
(function () {
  ...
  var MAGIC_FACT = {
    ...
    sk_summon: ['召喚物隨等級自動換階(七種：32/40/52/60/64/72 級，Lv72 黑豹最強，60 級以上附額外觸發技)', '傷害命中吃魅力；每輪段數＝魅力÷6(魅力 60 封頂、最多 10 段)，召喚精通時判定改魅力×1.2', '同時只能開一個召喚增益(造屍/召喚/精靈)，迷魅可並存'],
    ...
    sk_elf_summon2: ['每 1 秒攻擊一次；每擊＝骰值 2~80 ＋ 魅力×等級÷10、命中偏移 +20(較初階精靈更強)，吃魅力', '隻數公式同屬性精靈(1＋魅力÷10、上限 7、魅力封頂 60)；同時只能開一個召喚增益'],
    ...
    sk_dragon_lavaspit: ['傷害吃智力(魔法傷害)，純力量龍騎放這招很弱', '受火屬性剋制加減；龍血套裝 5/5 讓消耗 HP 類技能傷害 +20%、龍血精通則 HP 消耗減半'],
    ...
    sk_dragon_lavabolt: ['傷害吃智力(魔法傷害)，純力量龍騎放這招很弱', '受火屬性剋制加減、龍血套裝 5/5 傷害 +20%'],
    ...
    sk_dragon_deathlightning: ['傷害吃智力(魔法傷害)，純力量龍騎放這招很弱', '附「暈眩」6 秒依魔法命中判定、王級免疫暈眩'],
