...
(function () {
  ...
  var MERC_SKILL_COMMON = [
    ...
    '<b>自我增益</b>：傭兵只維持「來源角色有勾『自動施放』」的增益（跟他自己玩時一致）；他沒開的不會自己放。隊伍面板另有逐兵「<b>自動維持</b>」勾選可個別關閉（見「傭兵」分頁）。',
    '<b>淨化</b>：學過解毒／聖潔之光／相消的傭兵，會自動幫全隊解異常（一次一人、優先你）。',
    '⚡ <b>普攻攻速與本尊同一套算法</b>：由「職業×武器」基礎攻速，再乘上他自己維持的全部加速類效果（加速術／強力加速／勇敢／餅乾／切割／各攻速精通／覺醒／血之渴望／變身，並吃負重懲罰）。',
    '🌟 <b>團隊增益全隊生效</b>：大地的祝福／鋼鐵防護／水之元氣／幻覺光環（歐吉／巫妖／鑽石高崙／化身）由<b>任一隊員（你或傭兵）維持即全隊生效</b>；隊上已有人維持同一個時，其他人不重複施放。',
    '🚫 <b>禁用</b>：完全免疫類（絕對屏障／大地屏障／魔法屏障）傭兵不自動維持（否則近乎無敵）。'
  ];
  var MERC_SKILL_ROWS = [
    { c: '🔵 法師',
    ...
    { c: '👑 王族',
      ...
      special: '呼喚盟友要「場上有其他傭兵」才有意義（王族可帶最多 7 名傭兵，人越多越有價值）。' },
    { c: '🐉 龍騎士',
    ...
    { c: '🔮 幻術士',
      ...
      special: '幻覺歐吉／巫妖／鑽石高崙／化身的<b>「全隊加成」由任一隊員維持即全隊生效</b>——幻術士傭兵維持的光環，你和其他隊員也吃得到（隊上已有人維持時不重複施放）；幻象本體（歐吉／巫妖／鑽石高崙幫打）仍需<b>幻術精通</b>才會出。' }
  ];
  ...
  function renderAlly() {
    ...
    var c6 = card('⑥ 傭兵會繼承本尊哪些能力', { lines: [
      ...
      '🌟 <b>團隊增益「任一隊員維持、全隊生效」</b>：大地的祝福（防禦(AC) −7）／鋼鐵防護（受傷 −5%）／水之元氣（下次治癒加倍）與幻覺系光環（歐吉 額外傷害+4·命中+4、巫妖 魔法傷害+2、鑽石高崙 防禦(AC) −10、化身 額外傷害+10·受傷 −3%）——<b>傭兵維持的也讓你和全隊吃到</b>，不再是隊長專屬；隊上已有人維持同一個時，其他人不重複施放（不白耗 MP）。<b>各職業當傭兵實際能用哪些技能，見「傭兵可用技能」分頁。</b>'
    ]});
