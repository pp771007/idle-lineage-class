...
(function () {
  ...
  var EFFECT_OVERRIDE = {
    ...
    sk_charm: '魅惑一隻非王級怪物，使牠為你作戰（持續 1 小時；成功率最高約 6 成，有召喚精通時對比你低等的怪必定成功）。迷魅不佔召喚增益名額、可與一隻召喚物並存，被迷魅夥伴的命中與傷害隨魅力提升（見「能力值」）',
    ...
    sk_elf_summon: '依你選定的屬性召喚屬性精靈為你作戰；學了精靈精通可同時召喚多隻（最多 4 隻，見「能力值」）。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
    sk_elf_summon2: '召喚比一般屬性精靈更強的上級屬性精靈作戰；精靈精通同樣可同時召喚多隻。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
    sk_summon: '召喚一隻生物為你作戰（強度隨等級提升）；攻擊段數與命中傷害隨魅力提升（見「能力值」）。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
    sk_zombie: '造出一隻人形殭屍隨從替你作戰；攻擊段數與命中傷害隨魅力提升（見「能力值」）。造屍術／召喚術／屬性精靈這類召喚增益同時只能開一個，迷魅術可另外並存',
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '魔防怎麼擋魔法', lines: [
      ...
      '大致是：<b>魔防 100 時魔法傷害砍半</b>（魔防每 2 點約減 1%）；超過 100 之後改成每 10 點再減約 1%，越堆效益越低。',
  ...
  var ENHANCE_SECTIONS = [
    ...
    { t: '強化上限與「淬鍊」（+11 以上）', lines: [
      '<b>強化上限依裝備類型不同：武器最高 +20、防具 +15、飾品 +10。</b>達到上限後，名稱不再顯示「+XX」，改冠上「<b>淬鍊</b>」前綴。',
      ...
      '<b>防具 +11~+15</b>：在 +10 的防禦之上再額外加——+11、+12 各多 +2，+13~+15 各多 +3。飾品沒有 +10 以上，維持每階線性。',
  ...
  var PLEDGE_SECTIONS = [
    ...
    { t: '攻城戰', lines: [
      ...
      '<b>獲勝獎勵（24 小時）</b>：全商店 <b>8 折</b>、開放「城堡」地區、回村按鈕變「回城」（回到打下的那座城）。'
    ]},
    { t: '魔物追蹤', lines: [
    ...
    { t: '打血盟敵人的好處與注意', lines: [
      ...
      '掉落：必掉王族搜索狀；野外血盟與攻城敵人另有 <b>1% 機率多掉一件攜帶物</b>（抽法同潘朵拉，可能已強化、稀有物權重加倍）。',
