...
(function () {
  ...
  var WEAPON_TRAITS = [
    ...
    { n: '弱點曝光（龍騎士鎖鏈劍）', d: '龍騎士專屬的鎖鏈劍，一般攻擊命中時 30% 機率對目標疊一層「弱點曝光」，最多 3 層。搭配二階龍魔法「屠宰者」（消耗 HP，立即多打 3 下近戰）命中時會消耗弱點曝光、每層額外 +10 傷害。「鎖刃精通」讓疊層必定觸發、上限提升到 5 層、每層使你最終傷害 +10%（最高 +50%）；「弱點精通」讓任意近戰武器都能疊、每層使目標更易被命中、且屠宰者不再消耗層數。代表武器：消滅者／破滅者／嗜血者／共鳴者鎖鏈劍。' }
  ];
  var WEAPON_BASICS = [
  ...
  var COMBAT_SECTIONS = [
    ...
    { t: '⚔ 經典模式（硬核挑戰）', lines: [
      ...
      '硬核懲罰：<b>物品掉落機率剩原本的 1/10</b>、<b>經驗值取得減半</b>、<b>怪物金幣只剩 10%</b>、<b>物品賣價只剩定價的 3%</b>（一般是 30%）。',
