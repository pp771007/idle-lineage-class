...
const DB = {
        ...
        "wpn_kurt_sword":    { n: "克特之劍", type: "wpn", dmgS: 15, dmgL: 11, hit: 9, dmgBonus: 5, spd: 0.8, req: "knight,elf", safe: 6, p: 152000, legend: true, gachaWeight: 1, spellProc: { skn: "極道落雷", dice: [6, 10], ele: "wind" }, procRateBase: 15, procRatePerEn: 1, d: "克特之劍，劍鋒間遊走著被馴服的雷霆。<br>15%機率額外施放極道落雷，每+1發動機率增加1%。" },
        ...
        // 🏺 遺物（上游 v3.2.x 新增批次）：夥伴/屬性之牙/處刑者/夢魘等 54 件
        ...
        // 🏺 遺物第 15 批(上游 v3.4.x·使用者 2026-07-17 拍板要跟):四大精靈王武器＋魔力阻抗襯衫等
        ...
        "arm_106": { n: "反射之盾", type: "arm", slot: "shield", ac: 2, req: "knight,elf", safe: 4, p: 28000, immStone: true, resNone: 10, d: "盾面如鏡，能將敵人的法術回擲其身。受到無屬性魔法傷害時減少 50%。", gachaWeight: 1, block: 40 },
		...
		"shd_redknight": { n: "紅騎士盾牌", type: "arm", slot: "shield", ac: 2, req: "knight", safe: 6, p: 9800, immStone: true, resNone: 20, d: "紅騎士團傳承的戰盾，染血的盾面磨礪出抗魔的韌性。受到無屬性魔法傷害時減少 20%。", gachaWeight: 20, block: 50 },
    ...
    towns: {
        ...
        "town_kent_castle": {
            ...
            npcs: [
                ...
                { id: "npc_pandora", n: "潘朵拉", title: "黑市", type: "exchange", d: "潘朵拉的黑市藏匿著來路不明的寶物，一次陳列 20 件商品，每 5 分鐘輪換一件，可直接購買。" },
        ...
        "town_giran": {
            ...
            npcs: [
                ...
                { id: "npc_bokin", n: "波金", title: "賽狗場", type: "race", d: "奇岩賽狗場的售票員，八隻名犬輪番競逐。買張票，賭牠們誰先衝過終點。" }
            ]
        },
        "town_heine": {
            n: "海音",
        ...
        "town_aden": {
            ...
            npcs: [
                ...
                { id: "npc_arkata", n: "聖使阿卡塔", title: "死亡經驗買回", type: "pray", classicOnly: true, d: "聖使阿卡塔能以聖光凝聚你死亡時散逸的經驗。每次死亡的實際經驗損失都會被記錄（最多 10 筆），可花費「死亡時等級×等級×1000」金幣，買回該筆損失經驗的 50%。" }   // 🕊️ 經典限定（classicOnly·一般模式死亡不損失經驗故不顯示）
            ]
        },
		...
		"town_ivory_tower": {
            ...
            npcs: [
                ...
                { id: "npc_mystic_mage", n: "神秘的魔法師", title: "魔杖改造", type: "craft", d: "不願透露姓名的魔法師，擅長以鋼鐵重鑄法器。以 +7 以上的瑪那魔杖或力量魔法杖，加上魔法寶石與金屬塊，鍛造出鋼鐵瑪那魔杖（成品為 +0；傳統模式則自帶隨機強化值）。" }
            ]
        },
        "town_witon": {
            n: "威頓村",
	...
	skills: {
        ...
        "sk_relic_silence": { n: "沉默", type: "atk", status: { kind: "magicseal", dur: 8, force: true } },   // 🏺 遺物「七彩鸚鵡喙」攻擊命中觸發用（procStatusSkill·非可學技能）；怪物用 magicseal(魔法封印) 實現沉默·js/03 施法閘讀 st.magicseal
        "sk_relic_slow": { n: "緩速", type: "atk", status: { kind: "slow", dur: 8, force: true } },   // 🐍 遺物「艾庫艾托的鞭笞藤」攻擊命中觸發（procStatusSkill·force·緩速＝敵攻擊間隔+1秒·js/03）
        ...
        "sk_relic_broken": { n: "損壞", type: "atk", status: { kind: "broken", dur: 8, force: true } },   // 🏺 遺物「巨人的拋投石」攻擊命中觸發（procStatusSkill·force·損壞＝敵一般攻擊傷害-2）
