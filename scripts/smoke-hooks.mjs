...
const need = ['[AFK]', '[AFK-slotinfo]', '[AFK-dex]', '[AFK-wiki]', '[AFK-fixes]', '[AFK-syncinfo]', '[AFK-statpts]', '[AFK-pwa]', '[AFK-storage]', '[AFK-history]', '[AFK-mobname]', '[AFK-training]', '[AFK-itemsearch]', '[AFK-skin]'];
